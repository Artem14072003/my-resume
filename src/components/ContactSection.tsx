...
export const ContactSection = () => {
    ...
    return (
        <MotionSection className={'max-w-300 mx-auto px-0 md:px-8'}>
            <section id={'contact'}>
                <div className={'grid grid-cols-1 lg:grid-cols-2 gap-16'}>
                    <div>
                        <h2
                            className={'text-[28px] md:[34px] lg:text-[42px] tracking-[-0.04em] font-extrabold ' +
                        ...
                        <p className={'text-base md:text-[18px] leading-[1.6] tracking-normal text-submarine mb-12 max-w-md'}>
                            Есть идея, задача или просто хотите, что-то написать? Напишите — я с удовольствием отвечу.
                        </p>
                        <div className={'flex flex-wrap items-start gap-2 md:gap-6 group mb-6 md:mb-3'}>
                            <div
                        ...
                        <div className={'flex flex-wrap items-start gap-2 md:gap-6 group'}>
                            <div
                                className={'w-12 h-12 rounded-full border! flex items-center border-limed-spruce! ' +
                            ...
                            <div>
                                ...
                                <a
                                    ...
                                    target={'_blank'}
                                    className={'text-[24px] md:text-[32px] leading-[1.3] tracking-[-0.01em] font-semibold text-submarine ' +
                    ...
                    <div className={'skillGlassPanel py-10 px-8 md:px-10 rounded-xl lg:ml-8'}>
                        <FormSection
                            formKey={formKey}
